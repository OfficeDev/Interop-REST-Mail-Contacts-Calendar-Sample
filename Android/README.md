...
Before you configure your app for Android, you need to [register your app with an Office 365 Developer account]. Once your app is registered, [install the Android SDK](#install-android-sdk) and you're ready to get started [configuring your app for Android](#android-configuration).
